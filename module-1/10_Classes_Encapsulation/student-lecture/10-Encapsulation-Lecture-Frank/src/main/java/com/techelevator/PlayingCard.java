 ...
 * @return the faceUp
 */
public boolean isFaceUp() {  //get method for a boolean is called is because we are asking a question
	return faceUp;
}
...
//method to convert a PlayingCard to a string
...
//equals method to compare two playing cards


public boolean equals(PlayingCard otherCard) {
	if ((this.value == otherCard.value) && (this.suit.contentEquals(otherCard.suit))){
