...
public class DollarAmount {
    ...
    public static final DollarAmount ZERO_DOLLARS = new DollarAmount(0); // constants are in caps with _ to separate words
    																	 // we've established a constant to represent a 0 amount 
