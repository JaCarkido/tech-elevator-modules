...
public class RTNValidator {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Scanner fileScanner = new Scanner(inputFile); //moved outside try block to have access to it b/c of scope 
		try{
			while(fileScanner.hasNextLine()) {        //loop while the file has a next line (method hasNextLine() returns if there is another line or not)
