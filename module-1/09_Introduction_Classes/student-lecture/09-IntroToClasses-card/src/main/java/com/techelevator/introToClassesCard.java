...
<<<<<<< HEAD
		...
		aCard.showCard(); // run show card using our PlayingCard object

		System.out.println("---------------------------------");
		
		PlayingCard card2 = new PlayingCard("hearts", 5); // instantiate  5 of hearts
		
		card2.showCard();
		
		System.out.println("---------------------------------");
		
		PlayingCard card3 = new PlayingCard ("Hearts", 12, "Queen", "Rectangle" );
		...
		System.out.println("Card 3 is a " + card3.getValueName());
