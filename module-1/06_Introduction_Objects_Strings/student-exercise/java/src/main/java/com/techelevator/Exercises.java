...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		lastTwo = str.substring(length - 2);
	...
	public String middleThree(String str) {
		...
		return str.substring(firstChar, firstChar + 3);
	}
	...
	public String altPairs(String str) {
		...
		for(int i = 0; i < str.length(); i++) {
			s = s + str.charAt(i);
			if ( i % 2 == 1) { // if even ex)0 i+1 so 0,1 but if odd then i+2 (i++ again when it goes through the loop) so 0,1,4,5
				i += 2;
			}
		}
